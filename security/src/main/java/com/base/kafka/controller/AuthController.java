...
import com.base.kafka.config.JwtConfig;
import com.base.kafka.dto.JwtResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> getToken(@RequestBody UserDto dto){
        ...
        return new ResponseEntity<>(new JwtResponse(jwtToken, userDetails.getUsername(), expiryDate,userDetails.getAuthorities()), HttpStatus.OK);
    }
